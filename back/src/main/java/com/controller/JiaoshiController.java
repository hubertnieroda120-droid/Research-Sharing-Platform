...
public class JiaoshiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		...
		String token = tokenService.generateToken(user.getId(), username,"jiaoshi",  "科研人员" );
    ...
    public R register(@RequestBody JiaoshiEntity jiaoshi){
		...
		// 【区块链：为老师生成确权地址】
		try {
			jiaoshi.setBlockchainAddress(com.utils.BlockChainUtil.generateWalletAddress());
		} catch (Exception e) {}
    ...
    public R query(JiaoshiEntity jiaoshi){
		...
		return R.ok("查询科研人员成功").put("data", jiaoshiView);
    }
