<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科研人员工号" prop="jiaoshigonghao">
          <el-input v-model="ruleForm.jiaoshigonghao" 
              placeholder="科研人员工号" clearable  :readonly="ro.jiaoshigonghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科研人员工号" prop="jiaoshigonghao">
              <el-input v-model="ruleForm.jiaoshigonghao" 
                placeholder="科研人员工号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科研人员姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming" 
              placeholder="科研人员姓名" clearable  :readonly="ro.jiaoshixingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科研人员姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="科研人员姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'&& !ro.keyanwenjian" label="科研文件" prop="keyanwenjian">
          <file-upload
          tip="点击上传科研文件"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.keyanwenjian?ruleForm.keyanwenjian:''"
          @change="keyanwenjianUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.keyanwenjian" label="科研文件" prop="keyanwenjian">
            <el-button type="text" size="small" @click="download($base.url+ruleForm.keyanwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="成员" prop="chengyuan">
          <el-input v-model="ruleForm.chengyuan" 
              placeholder="成员" clearable  :readonly="ro.chengyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="成员" prop="chengyuan">
              <el-input v-model="ruleForm.chengyuan" 
                placeholder="成员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科研机构账号" prop="xueyuanzhanghao">
          <el-input v-model="ruleForm.xueyuanzhanghao" 
              placeholder="科研机构账号" clearable  :readonly="ro.xueyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科研机构账号" prop="xueyuanzhanghao">
              <el-input v-model="ruleForm.xueyuanzhanghao" 
                placeholder="科研机构账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科研机构名称" prop="xueyuanmingcheng">
          <el-input v-model="ruleForm.xueyuanmingcheng" 
              placeholder="科研机构名称" clearable  :readonly="ro.xueyuanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科研机构名称" prop="xueyuanmingcheng">
              <el-input v-model="ruleForm.xueyuanmingcheng" 
                placeholder="科研机构名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="研究目的" prop="yanjiumude">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="研究目的"
                  v-model="ruleForm.yanjiumude" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yanjiumude" label="研究目的" prop="yanjiumude">
                    <span>{{ruleForm.yanjiumude}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="研究内容" prop="yanjiuneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="研究内容"
                  v-model="ruleForm.yanjiuneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yanjiuneirong" label="研究内容" prop="yanjiuneirong">
                    <span>{{ruleForm.yanjiuneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhicheng = true;
          ...
          if(o=='keyanwenjian'){
            this.ruleForm.keyanwenjian = obj[o];
	    this.ro.keyanwenjian = true;
            continue;
          }
          if(o=='chengyuan'){
	    ...
	    this.ro.chengyuan = true;
          ...
          if(o=='yanjiumude'){
            this.ruleForm.yanjiumude = obj[o];
	    this.ro.yanjiumude = true;
            continue;
          }
          if(o=='yanjiuneirong'){
	...
	if(this.ruleForm.keyanwenjian!=null) {
		this.ruleForm.keyanwenjian = this.ruleForm.keyanwenjian.replace(new RegExp(this.$base.url,"g"),"");
	}
...
var objcross = this.$storage.getObj('crossObj');
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `keyanketixiaoshen/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.keyanketixiaoshenCrossAddOrUpdateFlag = false;
						 this.parent.search();
    ...
    keyanwenjianUploadChange(fileUrls) {
	this.ruleForm.keyanwenjian = fileUrls;
	this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
