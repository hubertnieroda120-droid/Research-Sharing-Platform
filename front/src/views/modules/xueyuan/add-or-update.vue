<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="科研机构地址" prop="xueyuandizhi">
          <el-input v-model="ruleForm.xueyuandizhi" 
              placeholder="科研机构地址" clearable  :readonly="ro.xueyuandizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="科研机构地址" prop="xueyuandizhi">
              <el-input v-model="ruleForm.xueyuandizhi" 
                placeholder="科研机构地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  data() {
	...
	xueyuandizhi : false,
      ...
      rules: {
          xueyuanzhanghao: [
                { required: true, message: '科研机构账号不能为空', trigger: 'blur' },
          ],
          mima: [
                { required: true, message: '密码不能为空', trigger: 'blur' },
          ],
          xueyuanmingcheng: [
                { required: true, message: '科研机构名称不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          fuzeren: [
