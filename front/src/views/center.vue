<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="科研人员工号" prop="jiaoshigonghao">
          <el-input v-model="ruleForm.jiaoshigonghao" readonly              placeholder="科研人员工号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='jiaoshi'"  label="科研人员姓名" prop="jiaoshixingming">
          <el-input v-model="ruleForm.jiaoshixingming"               placeholder="科研人员姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="科研机构账号" prop="xueyuanzhanghao">
          <el-input v-model="ruleForm.xueyuanzhanghao" readonly              placeholder="科研机构账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="科研机构名称" prop="xueyuanmingcheng">
          <el-input v-model="ruleForm.xueyuanmingcheng"               placeholder="科研机构名称" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='xueyuan'"  label="科研机构地址" prop="xueyuandizhi">
          <el-input v-model="ruleForm.xueyuandizhi"               placeholder="科研机构地址" clearable></el-input>
        </el-form-item>
      </el-col>
